const InfoCard: React.FC = () => {
  return (
    <div className="relative flex items-center gap-4 w-[330px] h-[80px] p-4 bg-white rounded-lg shadow-lg overflow-hidden">
      {/* Wave SVG */}
      <svg
        className="absolute w-20 fill-blue-400/20 rotate-90 -left-8 top-8"
      ...
      {/* Icon Container */}
      <div className="w-10 h-10 flex justify-center items-center bg-blue-400/30 rounded-full">
        <svg
      ...
      <div className="flex flex-col justify-center flex-grow">
        <p className="text-blue-600 font-bold text-lg">Info message</p>
        <p className="text-sm text-gray-500">You just should know this</p>
      </div>
